...
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ5';
global.owner = process.env.OWNER_NUMBER  || '94783681488' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=jMlGVapA#JJEGu0rGW77_ICeMCCbBii6armR2dFu489do-7Apbag' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94783681488,94783681488" : process.env.MODERATORS ,    
